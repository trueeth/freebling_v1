...
export default function BizToggle() {
  return (
    <div className="items-center">
      <Link href="/">
        <Image className="motion-safe:animate-pulse hover:motion-safe:animate-none mb-6 cursor-pointer opacity-80 hover:opacity-100" src="/assets/imgs/business-toggle.svg" width="226" height="43" alt="Business Toggle" />
      </Link>
